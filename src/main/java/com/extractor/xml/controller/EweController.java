...
//
//import static com.extractor.xml.util.EmallUtil.addDataForEmallHeader;
//
//@RestController
...
//                                                                     @RequestParam("ewe_xml_file") MultipartFile eweFile,
...
//        List<EweXMLProduct> eweXMLProducts = eweVendor.getElementaXMLProducts(eweFile);
//        List<EweXMLProduct> updateeweData = eweVendor.updateEweData(eweXMLProducts, emallFile);
//
